...
<>
  ...
  // Setup Supabase
  // -----------------------
  const SUPABASE_URL = "https://YOUR_PROJECT.supabase.co"; // ganti dengan URL Supabase-mu
  const SUPABASE_ANON_KEY = "YOUR_ANON_KEY"; // ganti dengan anon key
  ...
  async function ambilSaran() {
    try {
      const { data, error } = await supabase
        ...
        .select("*")
        .order("createdAt", { ascending: false }); // terbaru di atas
